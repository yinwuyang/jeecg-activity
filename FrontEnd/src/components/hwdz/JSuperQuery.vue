<template>
  <div class="j-super-query-box">
    ...
    <j-modal
      ...
      :mask="false"
      :fullscreen="izMobile"
      class="j-super-query-modal JSuperQueryClass"
      style="top:5%;max-height: 95%;"
    >
      <template slot="footer">
        <div class="footerClass" @mousedown="move">
...
import JDate from '@/components/hwdz/JDate.vue'
...
import JAreaLinkage from '@comp/hwdz/JAreaLinkage'
...
export default {
  ...
  methods: {
    move(e) {
      ...
      let odiv = document.getElementsByClassName('j-super-query-modal')[0] //获取目标元素
      //算出鼠标相对元素的位置
      let disX = e.clientX - odiv.offsetLeft - 500
...
<style lang="less">
.ant-modal.j-super-query-modal.JSuperQueryClass {
  margin: 0;
  left: 50%;
  margin-left: -500PX;
  .ant-modal-footer{
