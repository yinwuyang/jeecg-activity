...
```vue
<script>
  import JDate from '@/components/hwdz/JDate'
  export default {
    name: "demo",
    components: {
      JDate
...
```vue
import JSuperQuery from '@/components/hwdz/JSuperQuery.vue';
  export default {
    name: "hwdzDemoList",
    components: {
      JSuperQuery
...
```js
import JTreeTable from '@/components/hwdz/JTreeTable'
export default {
...
<script>
  import JCheckbox from '@/components/hwdz/JCheckbox'
  export default {
...
<script>
  import JCodeEditor from '@/components/hwdz/JCodeEditor'
  export default {
...
<script>
  import JSlider from '@/components/hwdz/JSlider'
  export default {
    components: {JSlider},
    data() {
      return {
