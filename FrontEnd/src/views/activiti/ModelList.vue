<template>
  <a-card :bordered="false">
    ...
    >
      <span slot="revision" slot-scope="text">v.{{text}}</span>
      <span slot="metaInfo" slot-scope="text">
...
export default {
  ...
  methods: {
    ...
    createObjOk(e) {
      ...
      this.iframUrl = `${window._CONFIG['domianURL']}${this.url.create}?name=${this.createObj.name || ''}&key=${this
        .createObj.key || ''}&description=${this.createObj.description || ''}`
...
<<<<<<< HEAD:baseproject/Front/src/views/activiti/ModelList.vue
<style >
/* .ant-modal {
  top: 20px !important;
} */
...
>>>>>>> f6f1403b8fc3c4985af92be3b6bfff590840691f:baseproject/CodeNew/src/views/activiti/ModelList.vue
<style scoped>
