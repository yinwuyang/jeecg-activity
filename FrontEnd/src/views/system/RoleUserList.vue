<template>
  <a-row class="mainContentHeight" :gutter="12">
    <a-col class="mainContentHeight" :md="leftColMd" :sm="24">
    ...
    <a-col class="mainContentHeight" :md="rightColMd" :sm="24" v-if="this.rightcolval == 1">
      <a-card class="TableCardClass" :bodyStyle="{height:'100%'}" :bordered="false">
        <div style="position: absolute;right: 15px;z-index: 99;">
          <a-icon type="close-circle" @click.stop="hideUserList" />
        </div>
        <!-- 查询区域 -->
        <div class="table-page-search-wrapper">
        ...
        <div class="table-operator" :md="24" :sm="24">
          <a-button @click="handleAdd2" type="primary" icon="plus">新增用户</a-button>
